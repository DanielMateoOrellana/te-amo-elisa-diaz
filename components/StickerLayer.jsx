...
const Sticker = ({ children, x, y, rotate, delay, scale = 1 }) => {
    return (
        <motion.div
            ...
            whileInView={{ opacity: 0.9, scale: scale, rotate: rotate }}
            transition={{
                type: "spring",
                stiffness: 260,
                damping: 20,
...
// SVG Components for Doodles - Valentine Theme
const StarDoodle = () => (
    <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="text-rose-400">
        <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" fill="currentColor" fillOpacity="0.3" />
    </svg>
);

const HeartDoodle = () => (
    <svg width="50" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-red-500">
        <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" fill="currentColor" fillOpacity="0.3" />
    </svg>
);
...
const PlanetDoodle = () => (
    <svg width="70" height="70" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.0" className="text-rose-300">
...
const TextPlaceholder = ({ text, color = "rose" }) => {
    return (
        <div className="border-2 border-dashed border-rose-300 bg-white/60 backdrop-blur-sm p-4 rounded-xl text-center min-w-[120px]">
            <p className="text-rose-500 font-display text-xs tracking-widest uppercase font-bold">
                {text}
            </p>
            <p className="text-[10px] text-rose-400 mt-1">(Falta PNG)</p>
        </div>
    );
};
    ...
    return (
        <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden">
            ...
            <Sticker x="10%" y="90%" rotate={-10} delay={0.2}>
                <p className="font-display text-4xl md:text-6xl text-rose-300/40 rotate-[-10deg] select-none">Forever</p>
            </Sticker>
